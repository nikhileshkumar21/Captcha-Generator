This project is a simple captcha generator built using HTML5, CSS3, and JavaScript. It generates a random captcha string to protect web forms from automated submissions.
